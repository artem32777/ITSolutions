    ...
    function menuLinksHandler() {
        ...
        if (subItems) {
            subItems.forEach((el => {
                ...
                parentLi.classList.add("category");
            }));
            const headerMenu = document.querySelector(".header__menu");
            headerMenu.dataset.spollers = "768,max";
            const spoilers = headerMenu.querySelectorAll(".header__menu .category > a");
            spoilers.forEach((el => {
                el.dataset.spoller = "";
                el.addEventListener("click", (e => {
                    el.parentNode.classList.toggle("_spoller-active");
                }));
            }));
        }
    }
